...
<form action="./api/edit_vote.php" method="post" enctype="multipart/form-data">
    ...
    <div>
            ...
            <input type="file" name="img" id="img" value="<?= $rows[0]['img'] ?>">
        </div>
        <div>
            <img src="./upload/<?= $rows[0]['img'] ?>" style="width:50%;height:50vh;">
        </div>
    <div class="mb-3">
...
?>
        <div>
            ...
            <input type="text" name="opt[<?=$opt['opt_id']?>]" class="description-input" value="<?= $opt['opt']?>">
