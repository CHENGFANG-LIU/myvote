...
class DB {
    ...
    public $dsn="mysql:host=localhost;charset=utf8;dbname=s1120214";
    public $table;
    protected $user = "s1120214";
    protected $pw = "s1120214";
    protected $pdo;
    protected $result;
    ...
    function validate(){
        ...
        if($check[0]["count(*)"]==0 || empty($_SESSION["user_id"])){
            unset($_SESSION['user_id']);
            unset($_SESSION['email']);
            unset($_SESSION['pr']);
            echo "請先登入";
            $this->to('index.php?go=sign_in');
        }
    }
