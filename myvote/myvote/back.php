...
if(isset($_GET["topic_ic"])){
  $_SESSION["tmp_topic"]=$_GET["topic_ic"];
}
  ...
  <nav class="navbar navbar-expand-lg bg-light box">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
            <a class="nav-link " href="index.php?go=hot">首頁</a>
          </li>
          <li class="nav-item">
          ...
          switch ($_SESSION['pr']) {
            ...
            case 0:
              echo"
              <li class='nav-item'>
              <a class='nav-link' href='back.php?go=my_vote'>我的投票</a>
            </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="./api/log_out.php">登出</a>
          </li>
